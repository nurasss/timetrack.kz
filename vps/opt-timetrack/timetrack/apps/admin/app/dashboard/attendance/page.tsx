...
import { apiGetAttendance, apiGetEmployees, apiGetLocations } from '@/lib/api/service';
                  ...
                  <tr key={r.id} className="hover:bg-slate-50 cursor-pointer" onClick={() => setDetail(r)}>
                    ...
                    <td>
                      <div className="flex items-center gap-2">
                        ...
                        {r.photoUrl && <Camera className="w-3.5 h-3.5 text-slate-400" />}
                        {r.isOfflineSynced && <WifiOff className="w-3.5 h-3.5 text-amber-400" />}
                      </div>
                    </td>
                    <td>
                      <button
