...
export type IntegrationStatus = 'connected' | 'not_connected' | 'in_progress';
export type IntegrationCategory = 'accounting' | 'crm' | 'access_control' | 'messaging' | 'developer' | 'payments';
...
export interface Integration {
  ...
  icon: string; // короткая аббревиатура для плитки-иконки
